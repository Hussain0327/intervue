...
import { InterviewTab } from "@/lib/types/interview";
...
const TABS: { id: InterviewTab; label: string; icon: React.ReactNode }[] = [
  ...
  { id: "rubric", label: "Rubric", icon: <RubricIcon /> },
  { id: "resume", label: "Resume", icon: <ResumeIcon /> },
];

export function TabContainer({ activeTab, onTabChange }: TabContainerProps) {
  return (
    <div className="border-b border-teal-200/50 bg-white/50">
      <div className="flex">
        {TABS.map((tab) => {
            ...
            <button
              ...
              className={`
                ...
                ${isActive
                  ...
                  : "text-gray-500 border-transparent hover:text-teal-600 hover:bg-teal-50/30"
                }
              `}
            >
